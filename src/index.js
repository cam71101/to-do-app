...
const index = (() => {
    ...
    addToDoSubmitBtn.addEventListener("click", (e) => {
        e.preventDefault()
        const todo =  new Todo (titleInput.value, descriptionInput.value, dueDateInput.value, priorityInput.value, currentProject)
        saveToDo(todo)
        saveLocalStorage()
        clearDOM()
        createDOMS()
    ...
    //     projectDropdown.text = currentProject
    ...
    function createDOMS () {
        ...
        filteredTodos.forEach((todo) => {
            ...
            bindEvents(removeBtn, card, todo, expandBtn, expandContent, editButton, checkBox)
            render(card)   
    })
    function bindEvents(removeBtn, card, todo, expandBtn, expandContent, editButton, checkBox) {
        removeBtn.addEventListener("click",() => removeToDo(todo, card))
        expandBtn.addEventListener("click",() => expandCard(expandBtn, expandContent))
